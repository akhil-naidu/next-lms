...
export default function CareerFilters() {
  ...
  const renderFilters = (
    <>
      ...
      <Stack direction={{ xs: 'column', md: 'row' }} spacing={{ xs: 2.5, md: 1 }} className="mt-5">
  ...
  if (mdUp) {
    return <Box className="py-10">{renderFilters}</Box>;
  }

  return (
    <>
      <Stack alignItems="flex-end" className="py-6">
        <Button
          color="inherit"
          variant="contained"
