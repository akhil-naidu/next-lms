...
export default function CareerContactInfo() {
  return (
    <Container className="pb-10 pt-10 text-center md:pb-20 md:text-left">
      <Typography variant="h2">Get In Touch</Typography>
      <div className="mb-6 mt-4 md:mb-10">
        <p className="font-semibold">{`We'd love to talk about how we can help you.`}</p>
      </div>
